...
class ApiAuditLogsEntityEntityTypeEntityIdGetResponse200AuditLogsItem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @return mixed
     */
    public function getOperationJson()
    {
        return $this->operationJson;
    }
    /**
     * @param mixed $operationJson
     *
     * @return self
     */
    public function setOperationJson($operationJson): self
    {
    ...
    /**
     * @param mixed $principalName
     *
     * @return self
     */
    public function setPrincipalName($principalName): self
    {
