...
class ApiOauthClientsPostBody extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    /**
     * @param mixed $clientSecretRef
     *
     * @return self
     */
    public function setClientSecretRef($clientSecretRef): self
    {
        $this->initialized['clientSecretRef'] = true;
