...
class GetApiDispatchJob extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['clientIds', 'statuses', 'applications', 'subdomains', 'aggregates', 'codes', 'source', 'kind', 'subscriptionId', 'dispatchPoolId', 'messageGroup', 'createdAfter', 'createdBefore', 'page', 'size', 'sortField', 'sortOrder']);
     ...
     *
     *
     * @return null|\FlowCatalyst\Generated\Model\ApiDispatchJobsGetResponse200
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos(strtolower($contentType), 'application/json') !== false)) {
            return $serializer->deserialize($body, 'FlowCatalyst\Generated\Model\ApiDispatchJobsGetResponse200', 'json');
        }
    }
