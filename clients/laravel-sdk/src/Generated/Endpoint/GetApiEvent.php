...
class GetApiEvent extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    /**
     * @param array{
     *    "clientIds"?: string,
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['clientIds', 'applications', 'subdomains', 'aggregates', 'types', 'source', 'subject', 'correlationId', 'messageGroup', 'timeAfter', 'timeBefore', 'page', 'size', 'sortField', 'sortOrder']);
     ...
     *
     *
     * @return null|\FlowCatalyst\Generated\Model\ApiEventsGetResponse200
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos(strtolower($contentType), 'application/json') !== false)) {
            return $serializer->deserialize($body, 'FlowCatalyst\Generated\Model\ApiEventsGetResponse200', 'json');
        }
    }
