...
class ApiPrincipalsIdRolesPutResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiPrincipalsIdRolesPutResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiPrincipalsIdRolesPutResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiPrincipalsIdRolesPutResponse200();
        ...
        if (\array_key_exists('roles', $data) && $data['roles'] !== null) {
            ...
            foreach ($data['roles'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiPrincipalsIdRolesPutResponse200RolesItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiPrincipalsIdRolesPutResponse200::class => false];
    }
}