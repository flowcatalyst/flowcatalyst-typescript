...
class ApiOauthClientsIdPutResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiOauthClientsIdPutResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiOauthClientsIdPutResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiOauthClientsIdPutResponse200();
        ...
        if (\array_key_exists('applications', $data) && $data['applications'] !== null) {
            ...
            foreach ($data['applications'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, \FlowCatalyst\Generated\Model\ApiOauthClientsIdPutResponse200ApplicationsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiOauthClientsIdPutResponse200::class => false];
    }
}