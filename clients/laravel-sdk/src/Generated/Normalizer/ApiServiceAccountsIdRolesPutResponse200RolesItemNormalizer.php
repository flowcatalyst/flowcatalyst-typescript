...
class ApiServiceAccountsIdRolesPutResponse200RolesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiServiceAccountsIdRolesPutResponse200RolesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiServiceAccountsIdRolesPutResponse200RolesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiServiceAccountsIdRolesPutResponse200RolesItem();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiServiceAccountsIdRolesPutResponse200RolesItem::class => false];
    }
}