...
class ApiScheduledJobsInstancesGetResponse200InstancesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiScheduledJobsInstancesGetResponse200InstancesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiScheduledJobsInstancesGetResponse200InstancesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiScheduledJobsInstancesGetResponse200InstancesItem();
        ...
        if (\array_key_exists('deliveredAt', $data) && $data['deliveredAt'] !== null) {
            $object->setDeliveredAt($data['deliveredAt']);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['deliveredAt'] = $data->getDeliveredAt();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiScheduledJobsInstancesGetResponse200InstancesItem::class => false];
    }
}