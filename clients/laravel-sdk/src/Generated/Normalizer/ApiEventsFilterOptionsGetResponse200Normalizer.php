...
class ApiEventsFilterOptionsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200();
        ...
        if (\array_key_exists('applications', $data) && $data['applications'] !== null) {
            ...
            foreach ($data['applications'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200ApplicationsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('subdomains', $data) && $data['subdomains'] !== null) {
            ...
            foreach ($data['subdomains'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200SubdomainsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('aggregates', $data) && $data['aggregates'] !== null) {
            ...
            foreach ($data['aggregates'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200AggregatesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('types', $data) && $data['types'] !== null) {
            ...
            foreach ($data['types'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200TypesItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiEventsFilterOptionsGetResponse200::class => false];
    }
}