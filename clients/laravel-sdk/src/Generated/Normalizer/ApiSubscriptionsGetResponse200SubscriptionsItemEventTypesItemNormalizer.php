...
class ApiSubscriptionsGetResponse200SubscriptionsItemEventTypesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiSubscriptionsGetResponse200SubscriptionsItemEventTypesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiSubscriptionsGetResponse200SubscriptionsItemEventTypesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiSubscriptionsGetResponse200SubscriptionsItemEventTypesItem();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiSubscriptionsGetResponse200SubscriptionsItemEventTypesItem::class => false];
    }
}