...
class ApiSubscriptionsIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiSubscriptionsIdGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiSubscriptionsIdGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiSubscriptionsIdGetResponse200();
        ...
        if (\array_key_exists('eventTypes', $data) && $data['eventTypes'] !== null) {
            ...
            foreach ($data['eventTypes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiSubscriptionsIdGetResponse200EventTypesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('customConfig', $data) && $data['customConfig'] !== null) {
            ...
            foreach ($data['customConfig'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \FlowCatalyst\Generated\Model\ApiSubscriptionsIdGetResponse200CustomConfigItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiSubscriptionsIdGetResponse200::class => false];
    }
}