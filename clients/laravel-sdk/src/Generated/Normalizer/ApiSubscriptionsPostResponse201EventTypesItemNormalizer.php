...
class ApiSubscriptionsPostResponse201EventTypesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiSubscriptionsPostResponse201EventTypesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiSubscriptionsPostResponse201EventTypesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiSubscriptionsPostResponse201EventTypesItem();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiSubscriptionsPostResponse201EventTypesItem::class => false];
    }
}