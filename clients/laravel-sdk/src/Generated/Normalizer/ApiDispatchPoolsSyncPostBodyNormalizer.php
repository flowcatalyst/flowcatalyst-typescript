...
class ApiDispatchPoolsSyncPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiDispatchPoolsSyncPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiDispatchPoolsSyncPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiDispatchPoolsSyncPostBody();
        ...
        if (\array_key_exists('pools', $data) && $data['pools'] !== null) {
            ...
            foreach ($data['pools'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiDispatchPoolsSyncPostBodyPoolsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiDispatchPoolsSyncPostBody::class => false];
    }
}