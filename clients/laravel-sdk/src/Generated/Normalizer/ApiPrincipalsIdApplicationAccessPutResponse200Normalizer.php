...
class ApiPrincipalsIdApplicationAccessPutResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiPrincipalsIdApplicationAccessPutResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiPrincipalsIdApplicationAccessPutResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiPrincipalsIdApplicationAccessPutResponse200();
        ...
        if (\array_key_exists('applications', $data) && $data['applications'] !== null) {
            ...
            foreach ($data['applications'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiPrincipalsIdApplicationAccessPutResponse200ApplicationsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiPrincipalsIdApplicationAccessPutResponse200::class => false];
    }
}