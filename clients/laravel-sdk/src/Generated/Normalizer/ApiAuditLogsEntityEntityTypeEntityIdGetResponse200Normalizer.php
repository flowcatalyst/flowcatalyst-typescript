...
class ApiAuditLogsEntityEntityTypeEntityIdGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAuditLogsEntityEntityTypeEntityIdGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAuditLogsEntityEntityTypeEntityIdGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAuditLogsEntityEntityTypeEntityIdGetResponse200();
        ...
        if (\array_key_exists('auditLogs', $data) && $data['auditLogs'] !== null) {
            ...
            foreach ($data['auditLogs'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiAuditLogsEntityEntityTypeEntityIdGetResponse200AuditLogsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAuditLogsEntityEntityTypeEntityIdGetResponse200::class => false];
    }
}